...
- `LineChain::PointAlong` (`shape_line_chain.cpp:2671`) is only used by the multi dragger's `clipToOtherLine` (`pns_multi_dragger.cpp:313`), the last step of milestone 9 (note 06 section 9).
