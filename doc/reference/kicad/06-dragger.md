...
`:911` to `:1141`. Rebuild the arc as a circle tangent to two lines and passing through the cursor, clamped so the cursor stays in the region where such a circle exists.
